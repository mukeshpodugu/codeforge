...
exports.submitContactForm = exports.getDeveloperInfo = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const PORTFOLIO_CONTACTS_FILE = path_1.default.join(__dirname, '../../contacts.json');
// Ensure file exists
if (!fs_1.default.existsSync(PORTFOLIO_CONTACTS_FILE)) {
    fs_1.default.writeFileSync(PORTFOLIO_CONTACTS_FILE, JSON.stringify([], null, 2), 'utf8');
}
...
exports.getDeveloperInfo = getDeveloperInfo;
const submitContactForm = (req, res) => {
    ...
    try {
        const raw = fs_1.default.readFileSync(PORTFOLIO_CONTACTS_FILE, 'utf8');
        ...
        fs_1.default.writeFileSync(PORTFOLIO_CONTACTS_FILE, JSON.stringify(contacts, null, 2), 'utf8');
